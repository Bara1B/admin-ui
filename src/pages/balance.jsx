...
const BalancePage = () => {
  return (
    <MainLayout type="balance">
      ...
      {/* Jarak antar grid menggunakan gap-y-12 */}
      <div className="space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <CardB cardTitle="Credit Card" cardType="All Bank Ltd" logoSrc="/images/visa.png" accountNumber="1234 5678 9012 8***" totalAmount="$25,000" />
          <CardB cardTitle="Checking" cardType="All Bank Ltd" accountNumber="693 456 69 9****" totalAmount="$25,000" />
          <CardB cardTitle="Savings" cardType="Brsc Bank Ltd" accountNumber="133 456 886 8***" totalAmount="$25,000" /> {/* logoSrc not passed */}
        </div>
      </div>
    </MainLayout>
